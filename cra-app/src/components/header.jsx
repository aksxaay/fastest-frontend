...
import mainLogo from "../images/GalaxyWars2.png";
        ...
        <div className="flex items-center justify-between border-b-2 border-gray-100 py-4 md:justify-start md:space-x-10">
          <div className="flex justify-start lg:w-0 lg:flex-1">
            <a href="#">
              ...
              <img className="h-12 w-auto sm:h-10" src={mainLogo} alt="" />
            </a>
          </div>
                ...
                <>
                  <Popover.Button
                    className={classNames(
                      ...
                      "group inline-flex items-center rounded-md bg-black text-base font-medium hover:text-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                    )}
                  >
                    <span>Explore</span>
                    <ChevronDownIcon
                        ...
                        <div className="space-y-6 bg-gray-50 px-5 py-5 sm:flex sm:space-y-0 sm:space-x-10 sm:px-8">
                          {callsToAction.map((item) => (
                            <div key={item.name} className="flow-root">
                              <a
                                href={item.href}
                                className="-m-3 flex items-center rounded-md p-3 text-base font-medium text-gray-300 hover:bg-gray-100"
                              >
                                <item.icon
          ...
          <div className="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
            ...
            <a
              href="#"
              className="py- whitespace-nowrap px-6 pl-8 text-base font-medium text-gray-500 hover:text-gray-300"
            >
              Login
            </a>
          </div>
